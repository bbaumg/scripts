...
v_defaultapps="logrotate bind-utils cifs-utils vim openssh-clients wget ntp traceroute htop net-snmp net-snmp-utils"
...
case "$OSVer" in
	6)
		...
		;;
	7)
		systemctl start ntpd.service | tee -a $log
		systemctl enable ntpd.service | tee -a $log
		;;
	*)
		echo "That is weird...  What OS are you running... It is not RHEL/CENTOS 6 or 7"  | tee -a $log
		;;
